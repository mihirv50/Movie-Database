...
const Tvdetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      {/* Seasons */}
      <h1 className="text-2xl text-white font-semibold">Seasons</h1>
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
        {info.detail.seasons.length ? (
          info.detail.seasons.map((s, i) => (
            <div className="w-[15vh] mr-[10%]">
              <img
                className="min-w-[14vw] h-[30vh] object-cover rounded-lg"
          ...
          <h1 className="text-3x1 mt-5 text-white font-black text-center">
            Nothing to show
          </h1>
        )}
      </div>
